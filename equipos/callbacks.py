...
def lov_team(lov_majorLeague=None, lov_season=None):
    ...
    df = f.dataset_name(df=object_specs["lov_team"]["dataset_name"], filter_cols=filter_cols)
...
def fig_winPercentage(lov_majorLeague=None, lov_season=None, lov_team=None):
    ...
    df = f.dataset_name(
        df=object_specs["fig_winPercentage"]["dataset_name"], filter_cols=filter_cols
    )
...
def fig_runDifferential(lov_majorLeague=None, lov_season=None, lov_team=None):
    ...
    df = f.dataset_name(
        df=object_specs["fig_runDifferential"]["dataset_name"], filter_cols=filter_cols
    )
    obj = f.create_px_figure(
        df=df,
